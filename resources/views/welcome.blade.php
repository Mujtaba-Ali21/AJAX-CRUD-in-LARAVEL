...
<body>
    ...
    <div class="login-dark">
        ...
        <form class="shadow-lg p-3 mb-5 rounded" id="myForm">
            ...
            <div class="form-group">
                <input class="form-control" type="number" name="productId" placeholder="Product Id">
            </div>
            ...
            <div class="form-group">
                <button class="btn btn-primary btn-block" id="submitBtn" type="submit">Create Product</button>    
            </div>
            <a class="btn btn-primary btn-block" href="/show">See Products</a>
